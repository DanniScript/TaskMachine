...
function SearchBar() {
  ...
  return (
    <div className="searchbar">
      ...
      />
      <span>You have <strong>completed {completedTasksAmount}</strong> of {tasksAmount} tasks</span>
    </div>
  )
}
